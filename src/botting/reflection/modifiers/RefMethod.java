 ...
 * @author Everel
 */
public class RefMethod extends botting.reflection.modifiers.RefModifiers {
    ...
    public Type getASMReturnType() {
        return Type.getType(getReturnType());
    }

    /**
     * Gets the java botting.reflection API method representation
     *
     * @return constructor
     */
